...
|---|---|
| {task description} | `.agents/skills/{skill-name}/SKILL.md` |
...
| Task | Skill |
|---|---|
| Creating or auditing a SKILL.md | `.agents/skills/skill-builder/SKILL.md` |
| Designing a new .agent.md | `.agents/skills/agent-builder/SKILL.md` |
```
