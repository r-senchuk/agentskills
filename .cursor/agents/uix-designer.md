# Generated from .github/agents/uix-designer.agent.md; do not edit directly.
---
name: uix-designer
description: >-
  Use when auditing, designing, or implementing visual UI for a home-services renovation website:
  responsive layouts, conversion patterns, trust signals, photography, design tokens, and
  accessibility. Do NOT use for backend work, analytics infrastructure, generic copywriting, or
