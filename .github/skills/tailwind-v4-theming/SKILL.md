...
user-invocable: true
license: MIT
compatibility: "Works with Tailwind CSS v4, PostCSS, and Next.js 15+ projects using CSS-first configuration."
metadata:
...
Author, extend, and debug Tailwind CSS v4 design tokens and utility classes for the project using the CSS-first `@theme {}` configuration approach — no `tailwind.config.ts` involved.
