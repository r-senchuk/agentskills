...
Design and implement responsive layouts for the site that work flawlessly on mobile (375px+) first, then scale gracefully to tablet and desktop using Tailwind CSS v4 with the project token system.
